  ...
  return (
    <header className="home">
      ...
      <Container>
        ...
        {showWelcome && (
          <>
            ...
            <Row>
              <Column md={6}>
                <p>
                  Täältä voit katsoa jokaisen suomalaisen juna-aseman lähtevien sekä saapuvien junien aikataulun, tai nähdä kaikki rautatieverkostolla olevat aktiiviset junat.<br />
                  Huomaa, että joillakin junilla on GPS pois käytöstä, joten emme pysty näyttämään sijaintia.<br />
        ...
        <FormCheckSwitch id='cargo' name='cargo' value={true} onChange={() => props.setShowOnlyPassenger(!props.showOnlyPassenger)} checked={props.showOnlyPassenger} text='Näytä vain matkustajajunat' />
      </Container>
    </header>
  )
};
